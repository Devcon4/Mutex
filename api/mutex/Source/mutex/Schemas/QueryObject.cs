namespace mutex.Schemas
{
    ...
    public class QueryObject : ObjectGraphType<object>
    {
            ...
            IHumanRepository humanRepository)
        {
            ...
            this.FieldAsync<PostObject, Post>(
                "post",
                ...
                arguments: new QueryArguments(
                    ...
                    resolve: context => db.Posts.FirstOrDefaultAsync(p => p.PostId == context.GetArgument<int?>("id", null), context.CancellationToken)
                );
